# This is a demo of using React Query from the React app to dial out to a 3rd party service. 

Homepage contains component Example which calls to 3rd party using React Query
